-- Stage-2B: Add Journal Entry creation to purchase_invoice_create_atomic
-- This ensures NO purchase invoice can be created without a balanced, posted JE
...
BEGIN
    ...
    -- Insert JE Lines (Debit Inventory, Debit VAT if any, Credit Supplier AP)
    ...
    -- Line 3: Credit Supplier AP (total)
    INSERT INTO journal_entry_lines (
        journal_entry_id,
        account_id,
        debit_amount,
    ...
    -- Verify JE is balanced (governance check)
    IF NOT EXISTS (

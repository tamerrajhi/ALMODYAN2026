-- Fix: Remove duplicate returned_qty update from RPC
-- The trigger update_invoice_after_purchase_return already handles this automatically
...
BEGIN
  ...
  -- ============================================================
  -- STEP 9: Create Return Line Items
  -- NOTE: returned_qty on original line is updated automatically by
  -- the trigger update_invoice_after_purchase_return
  -- ============================================================
  FOR v_item IN SELECT * FROM jsonb_array_elements(v_items)
  LOOP
    v_invoice_line_id := (v_item->>'invoice_line_id')::uuid;
    ...
    -- Insert return line - trigger will auto-update returned_qty on original
    ...
    -- DO NOT manually update returned_qty - trigger handles it
  END LOOP;

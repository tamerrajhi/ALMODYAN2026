...
-- FIX: Resolve function ambiguity by using explicit NULL argument
-- Only change: line 135 in both RPCs: generate_purchase_return_number() -> generate_purchase_return_number(NULL)
...
BEGIN
  ...
  -- FIX: Use explicit NULL to resolve function overload ambiguity
  -- ============================================================
...
-- ============================================================
-- FIX 2: complete_purchase_return_general_atomic
-- ============================================================
...
BEGIN
  ...
  LOOP
    ...
    -- Insert invoice line for the return

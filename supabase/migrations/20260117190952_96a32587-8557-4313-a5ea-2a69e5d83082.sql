-- Fix: Update payment_voucher_atomic to use correct core_workflow_success signature
-- core_workflow_success expects: (client_request_id uuid, entity_id uuid, result jsonb)

-- POS-P2N-FIX: Enforce payload_hash match even when existing request succeeded
-- Fixes: C1 MISMATCH should be rejected, not return idempotent:true
...
'POS-P2N: Enforce payload_hash match even when existing request succeeded; return explicit CONFLICT_* error codes.';
-- P2C: Fix complete_pos_sale_atomic - split FOR UPDATE from aggregate to avoid 0A000
...
COMMENT ON FUNCTION public.complete_pos_sale_atomic(p_payload jsonb) IS 'Atomic POS sale - P2C patched: split FOR UPDATE from aggregate';
-- P-RET-JEWELRY-STATUS-PATCH: Fix sale_status column name + valid value
-- Only patches the UPDATE jewelry_items statement in the loop
...
BEGIN
  ...
  LOOP
    ...
    -- =====================================================
    -- PATCHED: Use sale_status (correct column) + 'returned' (valid constraint value)
    -- =====================================================
